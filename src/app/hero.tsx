      ...
      <div className="container mx-auto mt-28">
        <div className="grid grid-cols-12 text-center lg:text-left">
          <Card className="col-span-full rounded-xl border border-white bg-white/90 py-10 p-8 shadow-lg shadow-black/10 backdrop-blur-sm backdrop-saturate-200 xl:col-span-7">
            ...
            >
              Khai phá sức mạnh của web với các khóa học chuyên môn của chúng
              tôi
            </Typography>
            <Typography variant="lead" className="mb-10 mt-6 !text-gray-900">
              Bạn đã sẵn sàng bắt đầu một cuộc hành trình thú vị vào thế giới
              phát triển web chưa? Đừng tìm đâu xa! Chúng tôi là đối tác đáng
              tin cậy của bạn để nắm vững nghệ thuật phát triển web.
            </Typography>
